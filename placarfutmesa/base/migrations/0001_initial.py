    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf', models.CharField(help_text='Enter your 11-digit CPF without punctuation.', max_length=11, unique=True, validators=[django.core.validators.RegexValidator(message='CPF must be exactly 11 digits without punctuation.', regex='^\\d{11}$')], verbose_name='CPF')),
                ...
                ('association', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.associate')),
            ],
            options={
                'verbose_name': 'user',
